package com.ssginc.showpingrefactoring.member.config;

import com.ssginc.showpingrefactoring.member.exception.CustomAccessDeniedHandler;
import com.ssginc.showpingrefactoring.member.exception.CustomAuthenticationEntryPoint;
import com.ssginc.showpingrefactoring.member.jwt.JwtFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/api/products/**", "/stream/list", "/login/signup", "/check-duplicate", "/signup/send-code",
                                ...
                                "/favicon.ico", "/api/auth/**", "/user/userInfo", "/webrtc/webrtc/", "/report/report/"
                        ).permitAll()
